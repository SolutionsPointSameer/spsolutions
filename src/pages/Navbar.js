...
import { Tilt_Neon, Quicksand } from "next/font/google";
    ...
    const MenuToggle = ({ toggle }) => (
        <button onClick={toggle} className="nav-toggle-button" style={{ backgroundColor: "transparent", border: "0 solid transparent" }}>
            ...
            >
                <path
                    strokeLinecap="round"
                    style={isOpen ? { strokeWidth: 4, fill: "none", transition: "stroke-dasharray 400ms, stroke-dashoffset 400ms", stroke: "#E00C05", strokeDasharray: "25 160", strokeDashoffset: -64 } : { strokeWidth: 4, fill: "none", transition: "stroke-dasharray 400ms, stroke-dashoffset 400ms", stroke: "#E00C05", strokeDasharray: "25 160" }}
                    d="m 30,33 h 40 c 3.722839,0 7.5,3.126468 7.5,8.578427 0,5.451959 -2.727029,8.421573 -7.5,8.421573 h -20"
                />
                <path
                    strokeLinecap="round"
                    style={isOpen ? { strokeWidth: 4, fill: "none", transition: "stroke-dasharray 400ms, stroke-dashoffset 400ms", stroke: "#E00C05", strokeDasharray: "60 142", transformOrigin: "50%", transition: "transform 400ms", transform: "rotate(90deg)" } : { strokeWidth: 4, fill: "none", transition: "stroke-dasharray 400ms, stroke-dashoffset 400ms", stroke: "#E00C05", strokeDasharray: "60 142", transformOrigin: "50%", transition: "transform 400ms" }}
                    d="m 30,50 h 40"
                />
                <path
                    strokeLinecap="round"
                    style={isOpen ? { strokeWidth: 4, fill: "none", transition: "stroke-dasharray 400ms, stroke-dashoffset 400ms", stroke: "#E00C05", strokeDasharray: "25 85", transformOrigin: "50%", strokeDashoffset: -64 } : { strokeWidth: 4, fill: "none", transition: "stroke-dasharray 400ms, stroke-dashoffset 400ms", stroke: "#E00C05", strokeDasharray: "25 85", transformOrigin: "50%" }}
        ...
        <>
            ...
            >
                <div className="navbar-name-container">
                    ...
                    <Link href="#home" scroll={false} style={{ textDecoration: "none", userSelect: "none", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}><Image src={LOGO} alt="" height={46} width={46} style={{ padding: 0, margin: 0 }} /><span className={quicksand.className}>S P Solutions Point Pvt. Ltd.</span></Link>
                </div>
                {isMobile ? (
                    <motion.nav
                        initial={false}
                ...
                <ul
                    className={`${tiltNeon.className} nav-links-container`}
                >
                    <li><Link href="/" className="nav-links" scroll={false} >Home</Link></li>
                    ...
                    <li><Link href="/products" className="nav-links" scroll={false} >Products</Link></li>
                    <li><Link href="/clients" className="nav-links" scroll={false} >Clients</Link></li>
                    <li><Link href="/careers" className="nav-links" scroll={false} >Careers</Link></li>
